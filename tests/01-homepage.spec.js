...
test.describe('Homepage', () => {
  ...
  test('Navigation bar is visible', async ({ page }) => {
    ...
    await new (require('../pages/BasePage'))(page).takeScreenshot('homepage-navbar');
  });
  ...
  test('Main content area is visible', async ({ page }) => {
    ...
    await new (require('../pages/BasePage'))(page).takeScreenshot('homepage-content');
  });
  ...
  test('Market cards are displayed on homepage', async ({ page }) => {
    ...
    expect(count).toBeGreaterThan(0);
    await new (require('../pages/BasePage'))(page).takeScreenshot('homepage-markets');
  });
