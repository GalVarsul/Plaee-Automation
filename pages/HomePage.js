...
class HomePage extends BasePage {
  constructor(page) {
    ...
    // The site uses div.header-bitmart (Ant Design), NOT standard <nav>/<header> tags
    this.navLinks = page.locator('a[href*="/category/"]');
    ...
    // Hamburger menu button (top right ≡) — last <span> inside the header div
    this.hamburgerMenu = page.locator('div.header-bitmart > span').last();
  ...
  async getMarketCategories() {
    return await this.marketFilterTabs.allTextContents();
  }
  ...
  async verifyPageLoaded() {
    ...
    const hasNavbar = await this.isVisible('div.header-bitmart, a[href*="/category/"]');
